<%@ Page Language="C#" EnableEventValidation = "false" AutoEventWireup="true" CodeBehind="NoAuthority.aspx.cs" Inherits="OrixMvc.NoAuthority" %>
...
<!-- TOP BAR -->
	...
	<form id="loginform" runat="server"  >
		...
		<asp:ScriptManager ID="myScriptManager" runat="server" EnablePageMethods="true" />
			...
			<br/><div id="warning" class="warning-box round">沒有權限瀏覽這個頁面</div>
