...
namespace OrixModel
{
    ...
    public partial class or_case_jcic_contract_data
    {
        ...
        public string x34 { get; set; }
        public string x35 { get; set; }
        public string x36 { get; set; }
        public string x37 { get; set; }
        public string x38 { get; set; }
        public string x39 { get; set; }
        public string x40 { get; set; }
        public string x41 { get; set; }
        public string x42 { get; set; }
        public string x43 { get; set; }
        public string x44 { get; set; }
        public string x45 { get; set; }
        public string x46 { get; set; }
        public string x47 { get; set; }
        public string x48 { get; set; }
        public string x49 { get; set; }
        public string x50 { get; set; }
        public string x51 { get; set; }
        public string x52 { get; set; }
        public string x53 { get; set; }
        public string x54 { get; set; }
    }
}
