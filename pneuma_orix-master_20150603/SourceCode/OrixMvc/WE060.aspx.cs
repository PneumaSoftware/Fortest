...
namespace OrixMvc
{
    public partial class WE060 : OrixMvc.Pattern.PageParent
    {
        #region 引用Module設定
        //*******************begin 勿動***********************  
        /// <summary>
        ...
        private void Print_Click()
        {
            ...
            URL += "&Parameter2=" + this.RE_DATE.Text.Trim();            


            string js = "window.open('" + URL + "','','height=600,width=1024,status=yes,toolbar=yes,menubar=yes,location=no,Resizable = yes','_blank')";

            //指向報表頁面
          //  this.ClientScript.RegisterClientScriptBlock(this.GetType(), "url", js);
            this.setScript(js);
        }
        #endregion
