...
namespace OrixMvc
{
    public partial class WF040 : OrixMvc.Pattern.PageParent
    {
        #region 引用Module設定
        //*******************begin 勿動***********************  
        /// <summary>
        ...
        private void setDefaultValue()
        {
            ...
            this.DATE_S.Text = System.DateTime.Now.AddMonths(-1).ToString("yyyy/MM/21");
            this.DATE_E.Text = System.DateTime.Now.ToString("yyyy/MM/20");
        }
        #endregion
        ...
        private bool PrintCheck()
        {
            ...
            {
                if (this.DATE_E.Text.CompareTo(this.DATE_S.Text) <= 0)
                {
                    strMessage += "\\r\\n 拜訪日期迄期必須大於拜訪日期起值！";
                }
            }
        ...
        private void Print_Click()
        {
            ...
            URL += "&Parameter2=" + this.DATE_S.Text.Trim();
            URL += "&Parameter3=" + this.DATE_E.Text.Trim();
