...
namespace OrixMvc
{
    public partial class WF050 : OrixMvc.Pattern.PageParent
    {
        #region 引用Module設定
        //*******************begin 勿動***********************  
        /// <summary>
        ...
        private void Print_Click()
        {
            ...
            URL += "&Parameter2=" + this.FRC_CODE.Text.Trim();
            URL += "&Parameter3=" + this.DATE_S.Text.Trim() ;
            URL += "&Parameter4=" + this.DATE_E.Text.Trim();
