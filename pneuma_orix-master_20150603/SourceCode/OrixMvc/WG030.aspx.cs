...
namespace OrixMvc
{
    public partial class WG030 : PageParent
    {
        #region 引用Module設定
        //*******************begin 勿動***********************  
        /// <summary>
        ...
        private void Status_Click(string strStatus)
        {
            ...
            strSQL += " select a.BANK_NO,b.BANK_NAME,MTHD_DESC,";
            ...
            strSQL += " Leap_year,Feb_rate_Days,AMT_LONG_SHORT_LOAN=(case c.LONG_SHORT_LOAN WHEN 1 then '綜合' WHEN 2 THEN '長借' ELSE '短借' END ),a.Long_Short_LOAN,Credit_way,INTEREST_CAL,Fixed_interest,a.LOAN_MTHD_CODE,PAY_DIVD_DATE=dbo.f_DateAddSlash(PAY_DIVD_DATE), ";
